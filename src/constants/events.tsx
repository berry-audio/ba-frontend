export enum EVENTS {
  ...
  DSP_STATE_CHANGED = "dsp_state_changed",
  ...
  MULTIROOM_STREAM_UPDATE = "multiroom_stream_update",
  MULTIROOM_SERVER_ADDED = "multiroom_server_added",
  MULTIROOM_SERVER_UPDATED = "multiroom_server_updated",
  MULTIROOM_SERVER_REMOVED = "multiroom_server_removed",
  MULITROOM_SERVER_CONNECTED = "multiroom_server_connected",
  MULITROOM_SERVER_DISCONNECTED = "multiroom_server_disconnected",
